# Contributing to Schemact

> **Official Repository:** [github.com/ersinkoc/schemact](https://github.com/ersinkoc/schemact) | **Website:** [schemact.oxog.dev](https://schemact.oxog.dev)

First off, thank you for considering contributing to Schemact! It's people like you that make Schemact such a great tool.
...
This project and everyone participating in it is governed by the [Schemact Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code.
...
- **Environment** - OS, Node.js version, Schemact version, database type
...
2. Run schemact pull mydb --database mysql
3. See error
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/Schemact.git
cd Schemact
...
Schemact should **only** use Node.js built-ins. No external runtime dependencies.
...
- Opening a discussion on [GitHub](https://github.com/ersinkoc/schemact/discussions)
- Commenting on an [issue](https://github.com/ersinkoc/schemact/issues)
- Checking the [documentation](https://schemact.oxog.dev/docs.html)

Thank you for contributing to Schemact! 🎉
