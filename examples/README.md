...
This directory contains real-world schema examples demonstrating Schemact's capabilities across different application domains.
...
**Perfect for:** Learning Schemact basics, small content websites
...
schemact init
cp examples/e-commerce/01_core_schema.sact migrations/
```
...
```bash
# Configure your database in schemact.config.js
# Then apply
schemact up
```
...
Schemact automatically generates the correct SQL for your database:
...
- Check the main [Schemact README](../README.md) for more features
