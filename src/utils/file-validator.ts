 ...
 */
export class FileSizeError extends SchemactError {
  constructor(
    message: string,
 ...
 * @throws SchemactError if file cannot be accessed
 */
...
export async function validateFileSize(
  ...
  if (fileSize > maxSize) {
    ...
    throw new FileSizeError(
      ...
      `add 'maxMigrationFileSize' to your schemact.config.js file.`,
      filePath,
      fileSize,
      maxSize
    );
...
export async function validateTotalSize(
  ...
  if (totalSize > maxTotalSize) {
    ...
    throw new FileSizeError(
      ...
      `in your schemact.config.js file.`,
      '<multiple files>',
      totalSize,
      maxTotalSize
    );
