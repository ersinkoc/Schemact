/**
 * Demo: Test Schemact with all database generators
 * This script parses .sact files and shows SQL for PostgreSQL, MySQL, and SQLite
 */
...
console.log(c.bold('\n🎯 Testing Schemact Multi-Database Support\n'));
