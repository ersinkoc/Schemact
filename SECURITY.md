...
> **Repository:** [github.com/ersinkoc/schemact](https://github.com/ersinkoc/schemact) | **Website:** [schemact.oxog.dev](https://schemact.oxog.dev)

## Supported Versions

Currently supported versions of Schemact receiving security updates:
...
We take the security of Schemact seriously. If you believe you have found a security vulnerability, please report it to us as described below.
...
Schemact uses SHA-256 hashing to ensure migration files haven't been tampered with after being applied.
...
Schemact does NOT store database credentials. You provide credentials through your adapter configuration.

**Best Practices:**
- Use environment variables for credentials
- Never commit `schemact.config.js` with credentials
...
Schemact has **no runtime dependencies** to minimize supply chain attacks. It only uses Node.js built-in modules.
...
Schemact reads/writes files in these locations:
- Migration directory (default: `./migrations`)
- Ledger file (default: `./.schemact_ledger.json`)
- Config file (default: `./schemact.config.js`)

**Security Considerations:**
- Schemact does NOT follow symlinks
...
**Thank you for helping keep Schemact and its users safe!**
